...
handle_system_error(SessionId, Reason, CowboyFrom) ->
    FormattedReason = iolist_to_binary(
        io_lib:format(
            "~p",
            [Reason]
        )
